...
The symbol table.
### u-boot.bin: 
U-Boot in raw binary format, suitable for running on your device.
### u-boot.img: 
This is u-boot.bin with a U-Boot header added, suitable for uploading to a running copy of U-Boot.
### u-boot.srec: 
